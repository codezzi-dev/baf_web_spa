                ...
                <div className="p-8 space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">baf.ban@gmail.com</p>
                      <p className="text-gray-600">ban@mf.worldathletics.org</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">+880 1711-401018</p>
                      <p className="text-gray-600">+880 1746-629655</p>
                    </div>
                  </div>
