                        ...
                        : milestone.milestoneIconTag === "goal" ? Target
                          : milestone.milestoneIconTag === "talent" ? Users
                            : milestone.milestoneIconTag === "growth" ? TrendingUp
                              : Zap;
                const colors = ["tag-green", "tag-red", "tag-yellow"];
                  ...
                  >
                    ...
                    <div className={`flex-1 ${isEven ? "md:text-right" : "md:text-left"} `}>
                      <div className="border-none shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 rounded-xl bg-[#FBFBFB]">
                        <div className="p-8">
                          <div
                            className={`inline-block px-3 py-1 rounded-full ${color} border-none mb-4 text-sm font-semibold `}
                          >
                    ...
                    <div className="relative z-10 flex-shrink-0">
                      <div
                        className={`w-20 h-20 rounded-full bg-gradient-to-br bg-${color} flex items-center justify-center shadow-2xl`}
                      >
