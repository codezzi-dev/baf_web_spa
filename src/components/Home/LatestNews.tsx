...
import { StepGroup, NewsAnnouncement } from "@/api/types/home/home.type";
import sampleNews from '@/assets/images/home/latest-news/latest-news-4.jpg'
...
const LatestNews: React.FC<LatestNewsProps> = ({ newsData, newsAnnouncements }) => {
  // const newsItems = [
  //   {
  //     id: 1,
